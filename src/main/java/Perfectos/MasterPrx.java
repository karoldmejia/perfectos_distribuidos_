...
{
    default void recibirResultado(String idTarea, long[] perfectos)
    {
        recibirResultado(idTarea, perfectos, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void recibirResultado(String idTarea, long[] perfectos, java.util.Map<String, String> context)
    {
        _iceI_recibirResultadoAsync(idTarea, perfectos, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> recibirResultadoAsync(String idTarea, long[] perfectos)
    {
        return _iceI_recibirResultadoAsync(idTarea, perfectos, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> recibirResultadoAsync(String idTarea, long[] perfectos, java.util.Map<String, String> context)
    {
        return _iceI_recibirResultadoAsync(idTarea, perfectos, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_recibirResultadoAsync(String iceP_idTarea, long[] iceP_perfectos, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void findPerfectNumbers(long inicio, long fin, String idTarea)
    {
        findPerfectNumbers(inicio, fin, idTarea, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void findPerfectNumbers(long inicio, long fin, String idTarea, java.util.Map<String, String> context)
    {
        _iceI_findPerfectNumbersAsync(inicio, fin, idTarea, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> findPerfectNumbersAsync(long inicio, long fin, String idTarea)
    {
        return _iceI_findPerfectNumbersAsync(inicio, fin, idTarea, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> findPerfectNumbersAsync(long inicio, long fin, String idTarea, java.util.Map<String, String> context)
    {
        return _iceI_findPerfectNumbersAsync(inicio, fin, idTarea, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_findPerfectNumbersAsync(long iceP_inicio, long iceP_fin, String iceP_idTarea, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(false, context, null, ostr -> {
                     ostr.writeLong(iceP_inicio);
                     ostr.writeLong(iceP_fin);
                     ostr.writeString(iceP_idTarea);
                 }, null);
        return f;
    }
