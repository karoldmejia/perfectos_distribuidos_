...
{
    default long[] buscarPerfectos(long inicio, long fin, String idTarea)
    {
        return buscarPerfectos(inicio, fin, idTarea, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long[] buscarPerfectos(long inicio, long fin, String idTarea, java.util.Map<String, String> context)
    {
        return _iceI_buscarPerfectosAsync(inicio, fin, idTarea, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<long[]> buscarPerfectosAsync(long inicio, long fin, String idTarea)
    {
        return _iceI_buscarPerfectosAsync(inicio, fin, idTarea, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<long[]> buscarPerfectosAsync(long inicio, long fin, String idTarea, java.util.Map<String, String> context)
    {
        return _iceI_buscarPerfectosAsync(inicio, fin, idTarea, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<long[]> _iceI_buscarPerfectosAsync(long iceP_inicio, long iceP_fin, String iceP_idTarea, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<long[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "buscarPerfectos", null, sync, null);
